  ...
  return (
   <Datacss>
    <div className='home__data'>
      <h1 className='home__title'>Shivam Gupta
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className="home__description">
        I create intuitive and engaging web experiences, transforming ideas into reality with elegant design and code.
      </p>
      <a href="mailto:shivamg86041@gmail.com" target="_blank" className="button buttton--flex"> Say Hello<svg
