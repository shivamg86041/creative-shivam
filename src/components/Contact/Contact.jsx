...
const Contact = () => {
  ...
  const notifySuccess = () => toast.success("Email Sent! We will reach you soon");
  const notifyError = () => toast.error("Failed to send email. Please try again later.");

  const sendEmail = (e) => {
    e.preventDefault();

    emailjs
      .sendForm('service_ae51xlu', 'template_e8wt1jd', form.current, '9Zosa7o3TWLcLvqsE')  // Replace 'publicKey' with your actual public key or user ID
      .then((result) => {
        e.target.reset();
        notifySuccess();
      })
          ...
          <div className="contact__content">
            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <span className="contact__card-data">shivamg86041@gmail.com</span>
                <a href="mailto:shivamg86041@gmail.com" className="contact__button">
              ...
              <div className="contact__card">
                ...
                <span className="contact__card-data">+91-83949-98335</span>
                <a href="https://api.whatsapp.com/send?phone=8394998335&text=Hello, more information!" className="contact__button">
                  Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                </a>
              </div>
              ...
              <div className="contact__card">
                ...
                <span className="contact__card-data">Shivam Gupta</span>
                <a href="https://www.linkedin.com/in/shivam-gupta-57329123a/" className="contact__button">
                  Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                </a>
              </div>
            </div>
